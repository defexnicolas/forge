...
func managedWorkspaceSettings() []managedSetting {
	settings := []managedSetting{
		...
		{path: "output_style", value: func(cfg Config) any { return cfg.OutputStyle }},
		{path: "web_search.provider", value: func(cfg Config) any { return cfg.WebSearch.Provider }},
		{path: "web_search.api_key", value: func(cfg Config) any { return cfg.WebSearch.APIKey }},
		{path: "web_search.api_key_env", value: func(cfg Config) any { return cfg.WebSearch.APIKeyEnv }},
		{path: "web_search.base_url", value: func(cfg Config) any { return cfg.WebSearch.BaseURL }},
		{path: "claw.heartbeat_interval_seconds", value: func(cfg Config) any { return cfg.Claw.HeartbeatIntervalSeconds }},
		{path: "claw.dream_interval_minutes", value: func(cfg Config) any { return cfg.Claw.DreamIntervalMinutes }},
		{path: "claw.persona_name", value: func(cfg Config) any { return cfg.Claw.PersonaName }},
		{path: "claw.persona_tone", value: func(cfg Config) any { return cfg.Claw.PersonaTone }},
		{path: "claw.autonomy_policy", value: func(cfg Config) any { return cfg.Claw.AutonomyPolicy }},
		{path: "claw.tools_enabled", value: func(cfg Config) any { return cfg.Claw.ToolsEnabled }},
